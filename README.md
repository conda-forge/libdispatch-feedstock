...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libdispatch-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libdispatch-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add libdispatch
# for installing globally
pixi global install libdispatch
```
...
It is possible to list all of the versions of `libdispatch` available on your platform:
...
```
pixi search libdispatch --channel conda-forge
```
